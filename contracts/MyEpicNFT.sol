...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string [] firstWords = ["Goku", "Vegeta", "Gohan", "Piccolo", "Cell", "Broly"];
    string [] secondWords = ["Amazyng", "Strange", "Epic", "Giant", "Superior", "Incredible"];
    string [] thirdWords = ["Vacio", "Entrana", "Lomo", "Jamon", "Prosciutto", "Marota"];

    string [] colors = ["red", "#08C2A8", "yellow", "blue", "green", "black"];
